...
?>
    <h3 class="text-center pt-3">Servicios prestados</h3>
    <div class="container">
            ...
            <?php foreach ($servicios as $servicio) { ?>
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Referencia: <?php echo strtoupper($servicio->referencia); ?></h5>
                            <p class="card-text"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-fill" viewBox="0 0 16 16">
                                ...
                                </svg> <?php echo $servicio->servicio; ?></a></p>
